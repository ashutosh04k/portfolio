        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>Used OpenAi’s GptAPIs for natural language movie searches, enhancing user interactions and recommending movies.
                Enhanced Security with Firebase authentication, protecting user accounts and improving overall platform
                safety.Implemented Google Cloud Functions for scalable, serverless execution, optimizing resource use. Used TailwindCSS
                for responsive design and React Redux for state management, ensuring a seamless user experience. </p>
            </div>
            <footer> <ul className="tech-list"> <li>Redux</li> <li>React Js</li> <li>API Gateway</li> <li>TailwindCss</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/ashutosh04k/Ashutosh-Kumar--Frontend-Developer." target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="https://brainstormtest.netlify.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" /></a>
              </div>
            </header>
            <div className="body">
              <h3>Food Cart App- Task Codestorm</h3>
              <p>
                Restaurant Explorer is a React and Redux-based web app for discovering meals from around the world, powered by TheMealDB API. It includes dynamic meal filtering by area, modal-based detail views for meal cards, and a shimmer loading effect for images. Users can search meals by name, sort alphabetically, and navigate seamlessly with responsive pagination. The app integrates Redux for state management and Ant Design for a polished UI/UX, showcasing expertise in API integration, modern frontend frameworks, and design principles for a user-friendly meal exploration experience.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
